...
>>>>>>> fe4c3370c8895d5cd7384901b1e0e3ee687a7690
  },
  {
    imgsrc: pro2,
    title: "Login Form",
    text: "The key components for implementing a login and registration form with CRUD operations using Java. Create a User class to represent user data, including attributes like username, password, email, etc. Implement methods for CRUD operations such as createUser(), readUser(), updateUser(), and deleteUser().",
    view: "https://github.com/sharmakarnan/loginForm",
  },
   {
    imgsrc: pro3,
...
<<<<<<< HEAD
  ...
  },
  {
    ...
    text:  "Developed a full-stack web application using Java, Spring Boot, Hibernate, and MySQL for secure banking operations.Implemented RESTful APIs for account creation, balance check, and transaction management.Integrated React.js on the frontend for a responsive and user-friendly interface.Used Postman for API testing and ensured smooth frontend-backend communication.Enhanced performance and reliability through Spring Data JPA and optimized database queries.",
    view: "https://github.com/sharmakarnan/Online-Banking",
  },
  {
    imgsrc: pro5,
